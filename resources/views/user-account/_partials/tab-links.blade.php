<ul class="nav nav-pills mb-3 KeptPills" id="pills-tab" role="tablist">
    ...
    @if($user->user_type == '0' || $user->user_type == '2')
        <li class="nav-item"> <a data-tab-name="matched" class="nav-link active content-tabs" id="pills-Matches-tab" data-toggle="pill" href="#pills-Matches" role="tab" aria-controls="pills-Matches" aria-selected="false">Matches</a> </li>
    @endif
