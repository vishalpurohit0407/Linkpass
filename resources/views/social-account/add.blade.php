...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Please add social account details here.'),
        'class' => 'col-lg-12'
    ])
                ...
                <div class="card shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center ">
                            <h4 class="mb-0 ml-3">{{ __('Add Social Account') }}</h4>
                        </div>
                    </div>
                                ...
                                <div class="row row-example">
                                    ...
                                    <div class="col-6 col-md-4">
                                        <a href="javascript:void(0);">
                                            <img id="output" src="" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 140px;">
                                        </a>
                                    </div>
                                </div>
